...
%Read first image
Imags2 = cell(numImages,1);
for i=1:numImages
    Imags2{i} = readimage(imds, i);
end
ImagsCorrected = cell(numImages,1);
...
for z=1:numel(ImagsCorrected)
    ...
    imwrite(ImagsCorrected{z}, fNameImCorrected, 'Quality', 100);
end

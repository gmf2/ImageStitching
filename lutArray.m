function [ArrayCell,Rows,Columns] =  lutArray(ArrayFiles,dir,Rows,Columns)
ArrayCell=gpuArray;
Count=1;
%LEER IMAGENES 
...
for i=1: numImages
    if i<10
    ImagArray2(i) = str2num(ArrayFiles{i}(end-4:end-4));
    elseif i>=10 && i<100
    ImagArray2(i) = str2num(ArrayFiles{i}(end-5:end-4));
    elseif i>=100
    ImagArray2(i)= str2num(ArrayFiles{i}(end-6:end-4));
    end
end
if isequal(dir,'left')
    for i=1:Rows
